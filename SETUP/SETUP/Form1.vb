...
Public Class Form1
    ...
    Public FireDelayRightMouseUp As UInteger = 100 'autofire delay when right mouse is up
...
NExtY:
        ...
        End If
        MinBrightness = avgBrightness + 0.05 - (avgBrightness / 0.65 * 0.05)
        MinSaturation = avgsaturation + 0.25 - (avgsaturation / 0.8 * 0.25)
